...
public class ManagerTest {
	...
	/**
	 * Test method for first name getter and setter (No validation on this
	 * field)
	 */
	@Test
	...
	/**
	 * Test method for second name getter and setter. (No validation on this
	 * field)
	 */
	@Test
	...
	public void testDeptGettersAndSetters() {
		...
		assertEquals(2, manNormal2.getDept().size()); // already populated
														// department
		...
		assertEquals("Mary", ((Manager) manNormal1.getDept().get(2)).getFirstName()); // checking
																						// name
																						// of
																						// third
																						// employee
